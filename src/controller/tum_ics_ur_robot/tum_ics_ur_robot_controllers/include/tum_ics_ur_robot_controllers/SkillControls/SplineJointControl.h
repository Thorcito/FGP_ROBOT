#ifndef UR_ROBOT_LLI_SPLINE_JOINT_CONTROL_H
#define UR_ROBOT_LLI_SPLINE_JOINT_CONTROL_H
...
class SplineJointControl: public ControlEffort
{
    // Member variables
private:
...
//    bool m_startLimitClock;
    ...
    // Member Methods
public:
    SplineJointControl(Robot::KinematicModel *kModel,
                Robot::DynamicModel *dModel=NULL,
                       RobotControllers::ControlEffort *extCtrl=NULL,
                double weight=1.0,
                const QString& name="SplineJointCtrl");
    ~SplineJointControl();
...
#endif // UR_ROBOT_LLI_SPLINE_JOINT_CONTROL_H
