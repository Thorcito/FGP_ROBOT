#ifndef UR_ROBOT_LLI_JOINT_CONTROL_H
#define UR_ROBOT_LLI_JOINT_CONTROL_H
...
class JointControl: public ControlEffort
{
    // Member variables
private:
    ...
    double m_limitCicleTime;
    double m_limitCicleTime_1;
    double m_sLimitCicleTime;
    double m_dLimitCicleTime;
    bool m_startLimitClock;
    ...
    ros::Subscriber m_subsQd;
    bool m_getQdFromTopic;
    ...
    // Member Methods
public:
    JointControl(Robot::KinematicModel *kModel,
                Robot::DynamicModel *dModel=NULL,
                double weight=1.0,
                const QString& name="JointCtrl");
    ~JointControl();
    ...
    const bool isQdTopicEnabled() const;
...
private:
    ...
    void getQdfromTopic(const sensor_msgs::JointState::ConstPtr &msg);
...
#endif // UR_ROBOT_LLI_JOINT_CONTROL_H
