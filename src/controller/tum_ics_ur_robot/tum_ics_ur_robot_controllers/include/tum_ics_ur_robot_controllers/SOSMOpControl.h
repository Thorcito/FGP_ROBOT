#ifndef UR_ROBOT_LLI_SOSMOPCONTROL_H
#define UR_ROBOT_LLI_SOSMOPCONTROL_H
...
// Flo: ??? for now: SOSMOpCtrl
class SOSMOpControl: public ControlEffort
{
    // Member variables
private:
    ...
    // Member Methods
public:
    SOSMOpControl(Robot::KinematicModel *kModel,
                  Robot::DynamicModel *dModel=NULL,
                  double weight=1.0,
                  const QString& name="SOSMOpCtrl");
    ~SOSMOpControl();
...
#endif // UR_ROBOT_LLI_SOSMOPCONTROL_H
